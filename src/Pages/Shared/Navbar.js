        ...
        <div className="navbar bg-primary text-white">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-primary text-white rounded-box w-52 text-xl font-bold">
                        {menuItems}
                    </ul>
                </div>
                <Link to="/" className="btn btn-ghost normal-case text-2xl">KeyBoard Mania</Link>
            </div>
